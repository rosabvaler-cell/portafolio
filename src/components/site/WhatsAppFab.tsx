...
export const WhatsAppFab = () => {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50 group inline-flex items-center justify-center h-20 w-20 md:h-24 md:w-24 rounded-full bg-[#25D366] text-white shadow-[var(--shadow-soft)] hover:bg-[#128C7E] transition-all duration-500 hover:scale-105"
    >
      <span className="absolute inset-0 rounded-full bg-[#25D366]/30 animate-ping opacity-60" aria-hidden />
